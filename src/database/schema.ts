...
export const deliveryStatus = pgEnum("delivery_status", ["pending", "processing", "sent", "cancelled", "failed", "suppressed"]);
export const suppressedReason = pgEnum("suppressed_reason", ["superseded", "user_cancelled", "access", "quiet_stale", "snooze_stale", "no_longer_applicable", "empty"]);
