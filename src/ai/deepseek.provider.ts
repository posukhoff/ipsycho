...
export const DEEPSEEK_JSON_INSTRUCTION = [
  ...
  "Action is exactly one of create_task, task_batch, create_goal_plan, update_task, complete_task, update_occurrence, reschedule_occurrence, create_goal, update_goal, save_memory, update_memory, delete_memory, link_task_to_goal, change_reminder, change_series, update_settings.",
  ...
  "complete_task fields: type,source,confidence,taskId,expectedVersion.",
