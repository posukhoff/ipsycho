...
export function buildSystemPrompt(input: SystemPromptInput): string {
  const paragraphs = [
    ...
    // 16. Three worked examples of the shapes the production dialogs got wrong. They sit before
    // CURRENT_TIME so they stay inside the cacheable prefix of the prompt.
    [
      "EXAMPLES. Shapes only; ids, dates and wording come from the real message and CURRENT_CONTEXT.",
      'user: «Перенеси созвон с дизайнером на понедельник в 16:00, а звонок клиенту на четверг с 15:00 до 16:00.» (t1 = созвон, t2 = звонок клиенту) → {"reply":"Перенёс оба.","question":null,"actions":[{"type":"reschedule","intent":"explicit","task":{"id":"t1"},"when":{"mode":"exact","date":"2026-09-07","time":"16:00","durationMinutes":null},"reason":null,"scope":"occurrence","recurrence":null,"timezone":null},{"type":"reschedule","intent":"explicit","task":{"id":"t2"},"when":{"mode":"exact","date":"2026-09-10","time":"15:00","durationMinutes":60},"reason":null,"scope":"occurrence","recurrence":null,"timezone":null}],"topic":{"mode":"none","title":null,"summary":null}}',
      'user: «Создай задачу «Попросить обратную связь по лендингу» на пятницу в 12:00 и свяжи её с целью запуска группы.» (g1 = запуск группы) → {"reply":"Записал.","question":null,"actions":[{"type":"create_task","intent":"explicit","goal":{"id":"g1"},"title":"Попросить обратную связь по лендингу","why":null,"nextAction":null,"context":null,"checklist":null,"importance":"normal","kind":"task","when":{"mode":"exact","date":"2026-09-11","time":"12:00","durationMinutes":null},"recurrence":null,"reminder":null,"habit":null,"timezone":null}],"topic":{"mode":"none","title":null,"summary":null}}',
      'user: «Каждый вторник в 19:00 до конца сентября английский час, ближайший вторник пропусти.» → {"reply":"Поставил, ближайший вторник пропущен.","question":null,"actions":[{"type":"create_task","intent":"explicit","goal":null,"title":"Английский","why":null,"nextAction":null,"context":null,"checklist":null,"importance":"normal","kind":"task","when":{"mode":"exact","date":"2026-09-08","time":"19:00","durationMinutes":60},"recurrence":{"frequency":"weekly","interval":1,"weekdays":["TU"],"monthDays":null,"until":"2026-09-30","skipDates":["2026-09-08"],"missed":null},"reminder":null,"habit":null,"timezone":null}],"topic":{"mode":"none","title":null,"summary":null}}',
    ].join("\n"),
