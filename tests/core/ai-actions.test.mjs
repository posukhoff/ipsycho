...
const body = {
  title: "Позвонить клиенту", why: null, nextAction: null, context: null, checklist: null,
  importance: "normal", kind: "task", when: { mode: "exact", date: "2026-09-10", time: "10:30", durationMinutes: null },
...
test("explicit reversible actions apply immediately, inferred ones wait for confirmation", () => {
  const rows = [
    ...
    { type: "update_task", taskId: target.taskId, taskVersion: 1, patch: { title: "Новое", why: null, nextAction: null, context: null, checklist: null, importance: null, habit: null } },
    ...
    { type: "goal", op: "create", goalId: null, goalVersion: null, taskId: null, taskVersion: null, title: "Запустить курс", why: null, targetDate: null, status: null, reviewEnabled: null },
    { type: "goal", op: "link", goalId: "33333333-3333-4333-8333-333333333333", goalVersion: 1, taskId: target.taskId, taskVersion: 1, title: null, why: null, targetDate: null, status: null, reviewEnabled: null },
    ...
    { type: "settings", operation: "language", expectedVersion: 3, timezone: null, applyTimezoneTo: null, language: "ru", digestKind: null, enabled: null, time: null, weekday: null, weekdayStart: null, weekdayEnd: null, weekendStart: null, weekendEnd: null, snoozeUntilDate: null, snoozeUntilTime: null, eventOffsets: null, plannedTaskOffsetMinutes: null, criticalPostDueMinutes: null, seenNormalMinutes: null, seenRequiredMinutes: null, seenCriticalMinutes: null },
  ];
...
test("destructive, critical, habit, sensitive and quiet-hours-bypass actions always confirm", () => {
  const rows = [
    ...
    { type: "update_task", taskId: target.taskId, taskVersion: 1, patch: { title: null, why: null, nextAction: null, context: null, checklist: null, importance: "critical", habit: null } },
    { type: "update_task", taskId: target.taskId, taskVersion: 1, patch: { title: null, why: null, nextAction: null, context: null, checklist: null, importance: null, habit: { minimumAction: "a", desiredAction: "b", trigger: null } } },
    ...
    { type: "goal", op: "update", goalId: "33333333-3333-4333-8333-333333333333", goalVersion: 1, taskId: null, taskVersion: null, title: null, why: null, targetDate: null, status: "cancelled", reviewEnabled: null },
...
test("disabling habit mode is an ordinary explicit edit", () => {
  const action = explicit({ type: "update_task", taskId: target.taskId, taskVersion: 1, patch: { title: null, why: null, nextAction: null, context: null, checklist: null, importance: null, habit: { enabled: false } } });
