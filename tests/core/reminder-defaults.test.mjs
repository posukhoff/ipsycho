...
test("critical deadline includes post-due follow-up", () => {
  assert.deepEqual(defaultReminderTemplates({ kind: "task", timeMode: "deadline", importance: "critical", hasPlannedStart: false }).map(x => x.offsetMinutes), [-180,-60,-30,-15,0,60]);
});
