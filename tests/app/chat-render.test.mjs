...
test("a pending card renders the confirmation buttons on both delivery paths", () => {
  const rendered = renderChatResult({ ...base, text: "Отменю созвон.", pendingCount: 1, pendingTitles: ["Отменить «Созвон»"], pendingGroupId: "11111111-1111-1111-1111-111111111111" });
